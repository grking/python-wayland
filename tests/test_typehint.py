...
class TestTypeHinter(unittest.TestCase):
    ...
    def test_headers_constant(self):
        ...
        assert expected_headers == TypeHinter.HEADERS
    ...
    def test_process_members_requests(self):
        ...
        assert "def attach(buffer: wl_buffer, x: int) -> None:" in result
        assert '"""' in result
    ...
    def test_process_members_events(self):
        ...
        assert "@staticmethod" in result
        assert "def enter(output: wl_output) -> None:" in result
        assert "        @staticmethod" in result
    ...
    def test_process_members_with_return_type(self):
        ...
        assert "def create_surface() -> wl_surface:" in result
